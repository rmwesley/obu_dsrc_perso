...
class EfcTisVlCipCardme:
    ...
    _obj_ = [
        'CodePays',
        'NumeroDeOrdreSociete',
        'CodeSociete',
        'NumeroClient',
        'NumeroPorteur',
        'F-IDU',
        'NumeroDeOrdreProduit',
        'NumeroListeGare',
        'NumeroListeCalendrier',
        'Date-YYMM-Tis',
        'D-PRO',
        'DernierPointDePassage',
        'NumeroDeOrdre',
        'CodeGare',
        'NumeroDeVoie',
        'SensDeLaVoie',
        ...
        'PeriodeDeTarif',
        'TypeDeTarif',
        'CoutDeLaTransactionTTC',
        'CaractereDeObservation',
        'PointeurDeHistorique',
        'D-VET',
        'D-HIS',
        'D-GES',
        'D-PASS',
    ...
    #-----< CodePays >-----#
    CodePays = INT(name='CodePays', mode=MODE_TYPE)
    CodePays._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=1023)], ev=None, er=[])
    
    #-----< NumeroDeOrdreSociete >-----#
    NumeroDeOrdreSociete = INT(name='NumeroDeOrdreSociete', mode=MODE_TYPE)
    NumeroDeOrdreSociete._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=99)], ev=None, er=[])
    ...
    F_IDU._cont = ASN1Dict([
        ...
        ('numero-porteur', _F_IDU_numero_porteur),
        ])
    F_IDU._ext = None
    
    #-----< NumeroDeOrdreProduit >-----#
    NumeroDeOrdreProduit = OCT_STR(name='NumeroDeOrdreProduit', mode=MODE_TYPE)
    NumeroDeOrdreProduit._const_sz = ASN1Set(rv=[2], rr=[], ev=None, er=[])
    ...
    _Date_YYMM_Tis_year = INT(name='year', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Date_YYMM_Tis_year._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=99)], ev=None, er=[])
    _Date_YYMM_Tis_month = INT(name='month', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Date_YYMM_Tis_month._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=12)], ev=None, er=[])
    Date_YYMM_Tis._cont = ASN1Dict([
        ('year', _Date_YYMM_Tis_year),
        ('month', _Date_YYMM_Tis_month),
        ])
    Date_YYMM_Tis._ext = None
    ...
    D_PRO._cont = ASN1Dict([
        ...
        ('numero-liste-calendrier', _D_PRO_numero_liste_calendrier),
        ('date-fin-validite', _D_PRO_date_fin_validite),
        ])
    D_PRO._ext = None
    
    #-----< DernierPointDePassage >-----#
    DernierPointDePassage = INT(name='DernierPointDePassage', mode=MODE_TYPE)
    DernierPointDePassage._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[])
    
    #-----< NumeroDeOrdre >-----#
    NumeroDeOrdre = INT(name='NumeroDeOrdre', mode=MODE_TYPE)
    NumeroDeOrdre._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=999)], ev=None, er=[])
    ...
    #-----< NumeroDeVoie >-----#
    NumeroDeVoie = INT(name='NumeroDeVoie', mode=MODE_TYPE)
    NumeroDeVoie._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=99)], ev=None, er=[])
    
    #-----< SensDeLaVoie >-----#
    SensDeLaVoie = BOOL(name='SensDeLaVoie', mode=MODE_TYPE)
    
    #-----< ClasseVehicule >-----#
    ClasseVehicule = INT(name='ClasseVehicule', mode=MODE_TYPE)
    ClasseVehicule._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[])
    
    #-----< Date-YMMDD-Tis >-----#
    Date_YMMDD_Tis = SEQ(name='Date-YMMDD-Tis', mode=MODE_TYPE)
    _Date_YMMDD_Tis_year = INT(name='year', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Date_YMMDD_Tis_year._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=9)], ev=None, er=[])
    _Date_YMMDD_Tis_month = INT(name='month', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDataDictionary', 'Month')))
    _Date_YMMDD_Tis_day = INT(name='day', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Date_YMMDD_Tis_day._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=31)], ev=None, er=[])
    Date_YMMDD_Tis._cont = ASN1Dict([
        ('year', _Date_YMMDD_Tis_year),
        ('month', _Date_YMMDD_Tis_month),
        ('day', _Date_YMMDD_Tis_day),
        ])
    Date_YMMDD_Tis._ext = None
    
    #-----< HeureDuPassage >-----#
    HeureDuPassage = SEQ(name='HeureDuPassage', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDataDictionary', 'TimeCompact')))
    
    #-----< PeriodeDeTarif >-----#
    PeriodeDeTarif = INT(name='PeriodeDeTarif', mode=MODE_TYPE)
    PeriodeDeTarif._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=9)], ev=None, er=[])
    
    #-----< TypeDeTarif >-----#
    TypeDeTarif = INT(name='TypeDeTarif', mode=MODE_TYPE)
    TypeDeTarif._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=9)], ev=None, er=[])
    
    #-----< CoutDeLaTransactionTTC >-----#
    CoutDeLaTransactionTTC = INT(name='CoutDeLaTransactionTTC', mode=MODE_TYPE)
    CoutDeLaTransactionTTC._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=999999)], ev=None, er=[])
    
    #-----< CaractereDeObservation >-----#
    CaractereDeObservation = INT(name='CaractereDeObservation', mode=MODE_TYPE)
    CaractereDeObservation._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=127)], ev=None, er=[])
    
    #-----< PointeurDeHistorique >-----#
    PointeurDeHistorique = INT(name='PointeurDeHistorique', mode=MODE_TYPE)
    PointeurDeHistorique._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[])
    ...
    D_VET._cont = ASN1Dict([
        ...
        ('numero-de-voie', _D_VET_numero_de_voie),
        ('sens-de-la-voie', _D_VET_sens_de_la_voie),
        ('classe-vehicule', _D_VET_classe_vehicule),
        ('date-du-passage', _D_VET_date_du_passage),
        ('heure-du-passage', _D_VET_heure_du_passage),
        ('periode-de-tarif', _D_VET_periode_de_tarif),
        ('type-de-tarif', _D_VET_type_de_tarif),
        ('cout-de-la-transaction-ttc', _D_VET_cout_de_la_transaction_ttc),
        ('caractere-d-observation', _D_VET_caractere_d_observation),
        ('pointeur-d-historique', _D_VET_pointeur_d_historique),
        ])
    D_VET._ext = None
    ...
    D_GES._cont = ASN1Dict([
        ('date-limite-execption-grise', _D_GES_date_limite_execption_grise),
        ('reserved', _D_GES_reserved),
        ])
    D_GES._ext = None
    
    #-----< D-PASS >-----#
    D_PASS = OCT_STR(name='D-PASS', mode=MODE_TYPE)
    D_PASS._const_sz = ASN1Set(rv=[40], rr=[], ev=None, er=[])
    
    #-----< SerialNumber >-----#
    SerialNumber = OCT_STR(name='SerialNumber', mode=MODE_TYPE)
    SerialNumber._const_sz = ASN1Set(rv=[4], rr=[], ev=None, er=[])
    
    #-----< Date-YYWW-Tis >-----#
    Date_YYWW_Tis = SEQ(name='Date-YYWW-Tis', mode=MODE_TYPE)
    _Date_YYWW_Tis_year = INT(name='year', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Date_YYWW_Tis_year._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=99)], ev=None, er=[])
    _Date_YYWW_Tis_week = INT(name='week', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Date_YYWW_Tis_week._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=53)], ev=None, er=[])
    Date_YYWW_Tis._cont = ASN1Dict([
        ('year', _Date_YYWW_Tis_year),
        ('week', _Date_YYWW_Tis_week),
        ])
    Date_YYWW_Tis._ext = None
    ...
    #-----< AnomalyBits >-----#
    AnomalyBits = SEQ(name='AnomalyBits', mode=MODE_TYPE)
    _AnomalyBits_logical_error = BOOL(name='logical-error', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AnomalyBits_reserved1 = BOOL(name='reserved1', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AnomalyBits_reserved2 = BOOL(name='reserved2', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AnomalyBits_missing_data = BOOL(name='missing-data', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AnomalyBits_black_list = BOOL(name='black-list', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AnomalyBits_reserved5 = BOOL(name='reserved5', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AnomalyBits_reserved6 = BOOL(name='reserved6', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _AnomalyBits_reserved7 = BOOL(name='reserved7', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    AnomalyBits._cont = ASN1Dict([
        ('logical-error', _AnomalyBits_logical_error),
        ('reserved1', _AnomalyBits_reserved1),
        ('reserved2', _AnomalyBits_reserved2),
        ('missing-data', _AnomalyBits_missing_data),
        ('black-list', _AnomalyBits_black_list),
        ('reserved5', _AnomalyBits_reserved5),
        ('reserved6', _AnomalyBits_reserved6),
        ('reserved7', _AnomalyBits_reserved7),
        ])
    AnomalyBits._ext = None
    ...
    #-----< TisContainer >-----#
    TisContainer = CHOICE(name='TisContainer', mode=MODE_TYPE)
    _TisContainer_integer = INT(name='integer', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved1 = NULL(name='reserved1', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_octetstring = OCT_STR(name='octetstring', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_octetstring._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=127)], ev=[], er=[])
    _TisContainer_universalString = STR_UNIV(name='universalString', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_beaconId = NULL(name='beaconId', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_t_apdu = NULL(name='t-apdu', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_dsrcApplicationEntityId = NULL(name='dsrcApplicationEntityId', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_dsrc_Ase_Id = NULL(name='dsrc-Ase-Id', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_attrIdList = NULL(name='attrIdList', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_attrList = NULL(name='attrList', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved10 = NULL(name='reserved10', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved11 = NULL(name='reserved11', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved12 = NULL(name='reserved12', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved13 = NULL(name='reserved13', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved14 = NULL(name='reserved14', mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_time = NULL(name='time', mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_vector = SEQ_OF(name='vector', mode=MODE_TYPE, tag=(16, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    __TisContainer_vector__item_ = INT(name='_item_', mode=MODE_TYPE)
    __TisContainer_vector__item_._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=127)], ev=[], er=[])
    _TisContainer_vector._cont = __TisContainer_vector__item_
    _TisContainer_vector._const_sz = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=255)], ev=None, er=[])
    _TisContainer_reserved17 = NULL(name='reserved17', mode=MODE_TYPE, tag=(17, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved18 = NULL(name='reserved18', mode=MODE_TYPE, tag=(18, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved19 = NULL(name='reserved19', mode=MODE_TYPE, tag=(19, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved20 = NULL(name='reserved20', mode=MODE_TYPE, tag=(20, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved21 = NULL(name='reserved21', mode=MODE_TYPE, tag=(21, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved22 = NULL(name='reserved22', mode=MODE_TYPE, tag=(22, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved23 = NULL(name='reserved23', mode=MODE_TYPE, tag=(23, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved24 = NULL(name='reserved24', mode=MODE_TYPE, tag=(24, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved25 = NULL(name='reserved25', mode=MODE_TYPE, tag=(25, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved26 = NULL(name='reserved26', mode=MODE_TYPE, tag=(26, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved27 = NULL(name='reserved27', mode=MODE_TYPE, tag=(27, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved28 = NULL(name='reserved28', mode=MODE_TYPE, tag=(28, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved29 = NULL(name='reserved29', mode=MODE_TYPE, tag=(29, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved30 = NULL(name='reserved30', mode=MODE_TYPE, tag=(30, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved31 = NULL(name='reserved31', mode=MODE_TYPE, tag=(31, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved32 = NULL(name='reserved32', mode=MODE_TYPE, tag=(32, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved33 = NULL(name='reserved33', mode=MODE_TYPE, tag=(33, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved34 = NULL(name='reserved34', mode=MODE_TYPE, tag=(34, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved35 = NULL(name='reserved35', mode=MODE_TYPE, tag=(35, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved36 = NULL(name='reserved36', mode=MODE_TYPE, tag=(36, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved37 = NULL(name='reserved37', mode=MODE_TYPE, tag=(37, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved38 = NULL(name='reserved38', mode=MODE_TYPE, tag=(38, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved39 = NULL(name='reserved39', mode=MODE_TYPE, tag=(39, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved40 = NULL(name='reserved40', mode=MODE_TYPE, tag=(40, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved41 = NULL(name='reserved41', mode=MODE_TYPE, tag=(41, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved42 = NULL(name='reserved42', mode=MODE_TYPE, tag=(42, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved43 = NULL(name='reserved43', mode=MODE_TYPE, tag=(43, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved44 = NULL(name='reserved44', mode=MODE_TYPE, tag=(44, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved45 = NULL(name='reserved45', mode=MODE_TYPE, tag=(45, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved46 = NULL(name='reserved46', mode=MODE_TYPE, tag=(46, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved47 = NULL(name='reserved47', mode=MODE_TYPE, tag=(47, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved48 = NULL(name='reserved48', mode=MODE_TYPE, tag=(48, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved49 = NULL(name='reserved49', mode=MODE_TYPE, tag=(49, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved50 = NULL(name='reserved50', mode=MODE_TYPE, tag=(50, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved51 = NULL(name='reserved51', mode=MODE_TYPE, tag=(51, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved52 = NULL(name='reserved52', mode=MODE_TYPE, tag=(52, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved53 = NULL(name='reserved53', mode=MODE_TYPE, tag=(53, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved54 = NULL(name='reserved54', mode=MODE_TYPE, tag=(54, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved55 = NULL(name='reserved55', mode=MODE_TYPE, tag=(55, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved56 = NULL(name='reserved56', mode=MODE_TYPE, tag=(56, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved57 = NULL(name='reserved57', mode=MODE_TYPE, tag=(57, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved58 = NULL(name='reserved58', mode=MODE_TYPE, tag=(58, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved59 = NULL(name='reserved59', mode=MODE_TYPE, tag=(59, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved60 = NULL(name='reserved60', mode=MODE_TYPE, tag=(60, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved61 = NULL(name='reserved61', mode=MODE_TYPE, tag=(61, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved62 = NULL(name='reserved62', mode=MODE_TYPE, tag=(62, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved63 = NULL(name='reserved63', mode=MODE_TYPE, tag=(63, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved64 = NULL(name='reserved64', mode=MODE_TYPE, tag=(64, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved65 = NULL(name='reserved65', mode=MODE_TYPE, tag=(65, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved66 = NULL(name='reserved66', mode=MODE_TYPE, tag=(66, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved67 = NULL(name='reserved67', mode=MODE_TYPE, tag=(67, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved68 = NULL(name='reserved68', mode=MODE_TYPE, tag=(68, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved69 = NULL(name='reserved69', mode=MODE_TYPE, tag=(69, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved70 = NULL(name='reserved70', mode=MODE_TYPE, tag=(70, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved71 = NULL(name='reserved71', mode=MODE_TYPE, tag=(71, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved72 = NULL(name='reserved72', mode=MODE_TYPE, tag=(72, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved73 = NULL(name='reserved73', mode=MODE_TYPE, tag=(73, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved74 = NULL(name='reserved74', mode=MODE_TYPE, tag=(74, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved75 = NULL(name='reserved75', mode=MODE_TYPE, tag=(75, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved76 = NULL(name='reserved76', mode=MODE_TYPE, tag=(76, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved77 = NULL(name='reserved77', mode=MODE_TYPE, tag=(77, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved78 = NULL(name='reserved78', mode=MODE_TYPE, tag=(78, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reserved79 = NULL(name='reserved79', mode=MODE_TYPE, tag=(79, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse80 = NULL(name='reservedForFutureISOCENuse80', mode=MODE_TYPE, tag=(80, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse81 = NULL(name='reservedForFutureISOCENuse81', mode=MODE_TYPE, tag=(81, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse82 = NULL(name='reservedForFutureISOCENuse82', mode=MODE_TYPE, tag=(82, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse83 = NULL(name='reservedForFutureISOCENuse83', mode=MODE_TYPE, tag=(83, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse84 = NULL(name='reservedForFutureISOCENuse84', mode=MODE_TYPE, tag=(84, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse85 = NULL(name='reservedForFutureISOCENuse85', mode=MODE_TYPE, tag=(85, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse86 = NULL(name='reservedForFutureISOCENuse86', mode=MODE_TYPE, tag=(86, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse87 = NULL(name='reservedForFutureISOCENuse87', mode=MODE_TYPE, tag=(87, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse88 = NULL(name='reservedForFutureISOCENuse88', mode=MODE_TYPE, tag=(88, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse89 = NULL(name='reservedForFutureISOCENuse89', mode=MODE_TYPE, tag=(89, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse90 = NULL(name='reservedForFutureISOCENuse90', mode=MODE_TYPE, tag=(90, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse91 = NULL(name='reservedForFutureISOCENuse91', mode=MODE_TYPE, tag=(91, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse92 = NULL(name='reservedForFutureISOCENuse92', mode=MODE_TYPE, tag=(92, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _TisContainer_reservedForFutureISOCENuse93 = NULL(name='reservedForFutureISOCENuse93', mode=MODE_TYPE, tag=(93, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ...
    _TisContainer_reservedForFutureISOCENuse120 = NULL(name='reservedForFutureISOCENuse120', mode=MODE_TYPE, tag=(120, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    ...
    TisContainer._cont = ASN1Dict([
        ...
        ('reserved1', _TisContainer_reserved1),
        ('octetstring', _TisContainer_octetstring),
        ('universalString', _TisContainer_universalString),
        ('beaconId', _TisContainer_beaconId),
        ('t-apdu', _TisContainer_t_apdu),
        ('dsrcApplicationEntityId', _TisContainer_dsrcApplicationEntityId),
        ('dsrc-Ase-Id', _TisContainer_dsrc_Ase_Id),
        ('attrIdList', _TisContainer_attrIdList),
        ('attrList', _TisContainer_attrList),
        ('reserved10', _TisContainer_reserved10),
        ('reserved11', _TisContainer_reserved11),
        ('reserved12', _TisContainer_reserved12),
        ('reserved13', _TisContainer_reserved13),
        ('reserved14', _TisContainer_reserved14),
        ('time', _TisContainer_time),
        ('vector', _TisContainer_vector),
        ('reserved17', _TisContainer_reserved17),
        ('reserved18', _TisContainer_reserved18),
        ('reserved19', _TisContainer_reserved19),
        ('reserved20', _TisContainer_reserved20),
        ('reserved21', _TisContainer_reserved21),
        ('reserved22', _TisContainer_reserved22),
        ('reserved23', _TisContainer_reserved23),
        ('reserved24', _TisContainer_reserved24),
        ('reserved25', _TisContainer_reserved25),
        ('reserved26', _TisContainer_reserved26),
        ('reserved27', _TisContainer_reserved27),
        ('reserved28', _TisContainer_reserved28),
        ('reserved29', _TisContainer_reserved29),
        ('reserved30', _TisContainer_reserved30),
        ('reserved31', _TisContainer_reserved31),
        ('reserved32', _TisContainer_reserved32),
        ('reserved33', _TisContainer_reserved33),
        ('reserved34', _TisContainer_reserved34),
        ('reserved35', _TisContainer_reserved35),
        ('reserved36', _TisContainer_reserved36),
        ('reserved37', _TisContainer_reserved37),
        ('reserved38', _TisContainer_reserved38),
        ('reserved39', _TisContainer_reserved39),
        ('reserved40', _TisContainer_reserved40),
        ('reserved41', _TisContainer_reserved41),
        ('reserved42', _TisContainer_reserved42),
        ('reserved43', _TisContainer_reserved43),
        ('reserved44', _TisContainer_reserved44),
        ('reserved45', _TisContainer_reserved45),
        ('reserved46', _TisContainer_reserved46),
        ('reserved47', _TisContainer_reserved47),
        ('reserved48', _TisContainer_reserved48),
        ('reserved49', _TisContainer_reserved49),
        ('reserved50', _TisContainer_reserved50),
        ('reserved51', _TisContainer_reserved51),
        ('reserved52', _TisContainer_reserved52),
        ('reserved53', _TisContainer_reserved53),
        ('reserved54', _TisContainer_reserved54),
        ('reserved55', _TisContainer_reserved55),
        ('reserved56', _TisContainer_reserved56),
        ('reserved57', _TisContainer_reserved57),
        ('reserved58', _TisContainer_reserved58),
        ('reserved59', _TisContainer_reserved59),
        ('reserved60', _TisContainer_reserved60),
        ('reserved61', _TisContainer_reserved61),
        ('reserved62', _TisContainer_reserved62),
        ('reserved63', _TisContainer_reserved63),
        ('reserved64', _TisContainer_reserved64),
        ('reserved65', _TisContainer_reserved65),
        ('reserved66', _TisContainer_reserved66),
        ('reserved67', _TisContainer_reserved67),
        ('reserved68', _TisContainer_reserved68),
        ('reserved69', _TisContainer_reserved69),
        ('reserved70', _TisContainer_reserved70),
        ('reserved71', _TisContainer_reserved71),
        ('reserved72', _TisContainer_reserved72),
        ('reserved73', _TisContainer_reserved73),
        ('reserved74', _TisContainer_reserved74),
        ('reserved75', _TisContainer_reserved75),
        ('reserved76', _TisContainer_reserved76),
        ('reserved77', _TisContainer_reserved77),
        ('reserved78', _TisContainer_reserved78),
        ('reserved79', _TisContainer_reserved79),
        ('reservedForFutureISOCENuse80', _TisContainer_reservedForFutureISOCENuse80),
        ('reservedForFutureISOCENuse81', _TisContainer_reservedForFutureISOCENuse81),
        ('reservedForFutureISOCENuse82', _TisContainer_reservedForFutureISOCENuse82),
        ('reservedForFutureISOCENuse83', _TisContainer_reservedForFutureISOCENuse83),
        ('reservedForFutureISOCENuse84', _TisContainer_reservedForFutureISOCENuse84),
        ('reservedForFutureISOCENuse85', _TisContainer_reservedForFutureISOCENuse85),
        ('reservedForFutureISOCENuse86', _TisContainer_reservedForFutureISOCENuse86),
        ('reservedForFutureISOCENuse87', _TisContainer_reservedForFutureISOCENuse87),
        ('reservedForFutureISOCENuse88', _TisContainer_reservedForFutureISOCENuse88),
        ('reservedForFutureISOCENuse89', _TisContainer_reservedForFutureISOCENuse89),
        ('reservedForFutureISOCENuse90', _TisContainer_reservedForFutureISOCENuse90),
        ('reservedForFutureISOCENuse91', _TisContainer_reservedForFutureISOCENuse91),
        ('reservedForFutureISOCENuse92', _TisContainer_reservedForFutureISOCENuse92),
        ('reservedForFutureISOCENuse93', _TisContainer_reservedForFutureISOCENuse93),
        ('reservedForFutureISOCENuse94', _TisContainer_reservedForFutureISOCENuse94),
        ('reservedForFutureISOCENuse95', _TisContainer_reservedForFutureISOCENuse95),
        ('reservedForFutureISOCENuse96', _TisContainer_reservedForFutureISOCENuse96),
        ('f-idu', _TisContainer_f_idu),
        ('d-pro', _TisContainer_d_pro),
        ('d-vet', _TisContainer_d_vet),
        ('d-his0', _TisContainer_d_his0),
        ('d-his1', _TisContainer_d_his1),
        ('d-his2', _TisContainer_d_his2),
        ('d-his3', _TisContainer_d_his3),
        ('d-his4', _TisContainer_d_his4),
        ('d-his5', _TisContainer_d_his5),
        ('d-his6', _TisContainer_d_his6),
        ('d-his7', _TisContainer_d_his7),
        ('d-his8', _TisContainer_d_his8),
        ('d-his9', _TisContainer_d_his9),
        ('d-his10', _TisContainer_d_his10),
        ('d-his11', _TisContainer_d_his11),
        ('d-his12', _TisContainer_d_his12),
        ('d-his13', _TisContainer_d_his13),
        ('d-his14', _TisContainer_d_his14),
        ('d-his15', _TisContainer_d_his15),
        ('d-ges', _TisContainer_d_ges),
        ('reservedForFutureISOCENuse117', _TisContainer_reservedForFutureISOCENuse117),
        ('reservedForFutureISOCENuse118', _TisContainer_reservedForFutureISOCENuse118),
        ('reservedForFutureISOCENuse119', _TisContainer_reservedForFutureISOCENuse119),
        ('reservedForFutureISOCENuse120', _TisContainer_reservedForFutureISOCENuse120),
        ('reservedForFutureISOCENuse121', _TisContainer_reservedForFutureISOCENuse121),
        ('reservedForFutureISOCENuse122', _TisContainer_reservedForFutureISOCENuse122),
        ('reservedForFutureISOCENuse123', _TisContainer_reservedForFutureISOCENuse123),
        ('d-pass', _TisContainer_d_pass),
        ('d-eve', _TisContainer_d_eve),
        ('d-obs', _TisContainer_d_obs),
        ('reservedForFutureISOCENuse127', _TisContainer_reservedForFutureISOCENuse127),
        ])
    TisContainer._ext = []
    ...
    _all_ = [
        CodePays,
        NumeroDeOrdreSociete,
        _CodeSociete_code_pays,
        _CodeSociete_numero_sca,
        CodeSociete,
        NumeroClient,
        NumeroPorteur,
        _F_IDU_code_societe_emettrice,
        _F_IDU_numero_client,
        _F_IDU_numero_porteur,
        F_IDU,
        NumeroDeOrdreProduit,
        NumeroListeGare,
        NumeroListeCalendrier,
        _Date_YYMM_Tis_year,
        _Date_YYMM_Tis_month,
        Date_YYMM_Tis,
        _D_PRO_numero_produit,
        _D_PRO_numero_liste_gare,
        _D_PRO_numero_liste_calendrier,
        _D_PRO_date_fin_validite,
        D_PRO,
        DernierPointDePassage,
        NumeroDeOrdre,
        _CodeGare_code_societe_circulee,
        _CodeGare_numero_d_ordre,
        CodeGare,
        NumeroDeVoie,
        SensDeLaVoie,
        ClasseVehicule,
        _Date_YMMDD_Tis_year,
        _Date_YMMDD_Tis_month,
        _Date_YMMDD_Tis_day,
        Date_YMMDD_Tis,
        HeureDuPassage,
        PeriodeDeTarif,
        ...
        CaractereDeObservation,
        PointeurDeHistorique,
        _D_VET_dernier_point_de_passage,
        _D_VET_code_gare,
        _D_VET_numero_de_voie,
        _D_VET_sens_de_la_voie,
        _D_VET_classe_vehicule,
        _D_VET_date_du_passage,
        _D_VET_heure_du_passage,
        _D_VET_periode_de_tarif,
        _D_VET_type_de_tarif,
        _D_VET_cout_de_la_transaction_ttc,
        _D_VET_caractere_d_observation,
        _D_VET_pointeur_d_historique,
        D_VET,
        D_HIS,
        _D_GES_date_limite_execption_grise,
        _D_GES_reserved,
        D_GES,
        D_PASS,
        SerialNumber,
        ...
        _Date_YYWW_Tis_week,
        Date_YYWW_Tis,
        _D_EVE_numero_de_serie_du_telebadge,
        _D_EVE_date_fabrication,
        D_EVE,
        _AnomalyBits_logical_error,
        _AnomalyBits_reserved1,
        _AnomalyBits_reserved2,
        _AnomalyBits_missing_data,
        _AnomalyBits_black_list,
        _AnomalyBits_reserved5,
        _AnomalyBits_reserved6,
        _AnomalyBits_reserved7,
        AnomalyBits,
        _D_OBS_erreur_logique,
        D_OBS,
        _TisContainer_integer,
        _TisContainer_reserved1,
        _TisContainer_octetstring,
        _TisContainer_universalString,
        _TisContainer_beaconId,
        _TisContainer_t_apdu,
        _TisContainer_dsrcApplicationEntityId,
        _TisContainer_dsrc_Ase_Id,
        _TisContainer_attrIdList,
        _TisContainer_attrList,
        _TisContainer_reserved10,
        _TisContainer_reserved11,
        _TisContainer_reserved12,
        _TisContainer_reserved13,
        _TisContainer_reserved14,
        _TisContainer_time,
        __TisContainer_vector__item_,
        _TisContainer_vector,
        _TisContainer_reserved17,
        _TisContainer_reserved18,
        _TisContainer_reserved19,
        _TisContainer_reserved20,
        _TisContainer_reserved21,
        _TisContainer_reserved22,
        _TisContainer_reserved23,
        _TisContainer_reserved24,
        _TisContainer_reserved25,
        _TisContainer_reserved26,
        _TisContainer_reserved27,
        _TisContainer_reserved28,
        _TisContainer_reserved29,
        _TisContainer_reserved30,
        _TisContainer_reserved31,
        _TisContainer_reserved32,
        _TisContainer_reserved33,
        _TisContainer_reserved34,
        _TisContainer_reserved35,
        _TisContainer_reserved36,
        _TisContainer_reserved37,
        _TisContainer_reserved38,
        _TisContainer_reserved39,
        _TisContainer_reserved40,
        _TisContainer_reserved41,
        _TisContainer_reserved42,
        _TisContainer_reserved43,
        _TisContainer_reserved44,
        _TisContainer_reserved45,
        _TisContainer_reserved46,
        _TisContainer_reserved47,
        _TisContainer_reserved48,
        _TisContainer_reserved49,
        _TisContainer_reserved50,
        _TisContainer_reserved51,
        _TisContainer_reserved52,
        _TisContainer_reserved53,
        _TisContainer_reserved54,
        _TisContainer_reserved55,
        _TisContainer_reserved56,
        _TisContainer_reserved57,
        _TisContainer_reserved58,
        _TisContainer_reserved59,
        _TisContainer_reserved60,
        _TisContainer_reserved61,
        _TisContainer_reserved62,
        _TisContainer_reserved63,
        _TisContainer_reserved64,
        _TisContainer_reserved65,
        _TisContainer_reserved66,
        _TisContainer_reserved67,
        _TisContainer_reserved68,
        _TisContainer_reserved69,
        _TisContainer_reserved70,
        _TisContainer_reserved71,
        _TisContainer_reserved72,
        _TisContainer_reserved73,
        _TisContainer_reserved74,
        _TisContainer_reserved75,
        _TisContainer_reserved76,
        _TisContainer_reserved77,
        _TisContainer_reserved78,
        _TisContainer_reserved79,
        _TisContainer_reservedForFutureISOCENuse80,
        _TisContainer_reservedForFutureISOCENuse81,
        _TisContainer_reservedForFutureISOCENuse82,
        _TisContainer_reservedForFutureISOCENuse83,
        _TisContainer_reservedForFutureISOCENuse84,
        _TisContainer_reservedForFutureISOCENuse85,
        _TisContainer_reservedForFutureISOCENuse86,
        _TisContainer_reservedForFutureISOCENuse87,
        _TisContainer_reservedForFutureISOCENuse88,
        _TisContainer_reservedForFutureISOCENuse89,
        _TisContainer_reservedForFutureISOCENuse90,
        _TisContainer_reservedForFutureISOCENuse91,
        _TisContainer_reservedForFutureISOCENuse92,
        _TisContainer_reservedForFutureISOCENuse93,
        _TisContainer_reservedForFutureISOCENuse94,
        _TisContainer_reservedForFutureISOCENuse95,
        _TisContainer_reservedForFutureISOCENuse96,
        _TisContainer_f_idu,
        _TisContainer_d_pro,
        _TisContainer_d_vet,
        _TisContainer_d_his0,
        _TisContainer_d_his1,
        _TisContainer_d_his2,
        _TisContainer_d_his3,
        _TisContainer_d_his4,
        _TisContainer_d_his5,
        _TisContainer_d_his6,
        _TisContainer_d_his7,
        _TisContainer_d_his8,
        _TisContainer_d_his9,
        _TisContainer_d_his10,
        _TisContainer_d_his11,
        _TisContainer_d_his12,
        _TisContainer_d_his13,
        _TisContainer_d_his14,
        _TisContainer_d_his15,
        _TisContainer_d_ges,
        _TisContainer_reservedForFutureISOCENuse117,
        _TisContainer_reservedForFutureISOCENuse118,
        _TisContainer_reservedForFutureISOCENuse119,
        _TisContainer_reservedForFutureISOCENuse120,
        _TisContainer_reservedForFutureISOCENuse121,
        _TisContainer_reservedForFutureISOCENuse122,
        _TisContainer_reservedForFutureISOCENuse123,
        _TisContainer_d_pass,
        _TisContainer_d_eve,
        _TisContainer_d_obs,
        _TisContainer_reservedForFutureISOCENuse127,
        TisContainer,
    ]
...
class EfcDataDictionary:
    ...
    _EfcContextMark_contextVersion._const_val = ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=255)], ev=None, er=[])
