...
class CccModule:
    ...
    #-----< CCC-InitialiseComm-Request >-----#
    CCC_InitialiseComm_Request = SEQ(name='CCC-InitialiseComm-Request', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'BST')))
    
    #-----< CCC-InitialiseComm-Response >-----#
    CCC_InitialiseComm_Response = SEQ(name='CCC-InitialiseComm-Response', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'VST')))
    
    #-----< CCC-DataRetrieval-Request >-----#
    CCC_DataRetrieval_Request = SEQ(name='CCC-DataRetrieval-Request', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Get-Request')))
    
    #-----< CCC-DataRetrieval-Response >-----#
    CCC_DataRetrieval_Response = SEQ(name='CCC-DataRetrieval-Response', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Get-Response')))
    
    #-----< CCC-AuthDataRetrieval-Request >-----#
    CCC_AuthDataRetrieval_Request = SEQ(name='CCC-AuthDataRetrieval-Request', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Action-Request')))
    
    #-----< CCC-AuthDataRetrieval-Response >-----#
    CCC_AuthDataRetrieval_Response = SEQ(name='CCC-AuthDataRetrieval-Response', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Action-Response')))
    
    #-----< CCC-Notification-Request >-----#
    CCC_Notification_Request = SEQ(name='CCC-Notification-Request', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Action-Request')))
    
    #-----< CCC-Notification-Response >-----#
    CCC_Notification_Response = SEQ(name='CCC-Notification-Response', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Action-Response')))
    
    #-----< CCC-TerminateComm >-----#
    CCC_TerminateComm = SEQ(name='CCC-TerminateComm', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Event-Report-Request')))
    
    #-----< CCC-TestComm-Request >-----#
    CCC_TestComm_Request = SEQ(name='CCC-TestComm-Request', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Action-Request')))
    
    #-----< CCC-TestComm-Response >-----#
    CCC_TestComm_Response = SEQ(name='CCC-TestComm-Response', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Action-Response')))
    
    #-----< ActiveContext >-----#
    ActiveContext = SEQ_OF(name='ActiveContext', mode=MODE_TYPE)
    _ActiveContext__item_ = SEQ(name='_item_', mode=MODE_TYPE)
    __ActiveContext__item__contextId = SEQ(name='contextId', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'Provider')))
    ...
    #-----< CCC-ContextMark >-----#
    CCC_ContextMark = SEQ(name='CCC-ContextMark', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcApplication', 'EFC-ContextMark')))
    
    #-----< CommunicationStatus >-----#
    CommunicationStatus = SEQ(name='CommunicationStatus', mode=MODE_TYPE)
    _CommunicationStatus_timeOfLastTransmission = INT(name='timeOfLastTransmission', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    _CommunicationStatus_pendingSince = INT(name='pendingSince', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    ...
    _GnssStatus_lastGnssFixTime = INT(name='lastGnssFixTime', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    ...
    _OBEStatusHistory_timeWhenChanged = INT(name='timeWhenChanged', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    _OBEStatusHistory_timeWhenActived = INT(name='timeWhenActived', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    _OBEStatusHistory_timeWhenObePowered = INT(name='timeWhenObePowered', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    ...
    _VehicleAxlesHistory_timeWhenChanged = INT(name='timeWhenChanged', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    _VehicleAxlesHistory_previousVehicleAxles = SEQ(name='previousVehicleAxles', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleAxles')))
    ...
    #-----< VehicleLicensePlateNumber >-----#
    VehicleLicensePlateNumber = SEQ(name='VehicleLicensePlateNumber', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcApplication', 'LPN')))
    ...
    _LastLAC_timeOfLAC = INT(name='timeOfLAC', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    _LastLAC_lACOperator = SEQ(name='lACOperator', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'Provider')))
    ...
    _Container_beaconId = SEQ(name='beaconId', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'BeaconID')))
    _Container_t_apdu = CHOICE(name='t-apdu', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'T-APDUs')))
    _Container_dsrcApplicationEntityId = INT(name='dsrcApplicationEntityId', mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'DSRCApplicationEntityID')))
    _Container_dsrc_Ase_Id = INT(name='dsrc-Ase-Id', mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')))
    _Container_attrIdList = SEQ_OF(name='attrIdList', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeIdList')))
    _Container_attrList = SEQ_OF(name='attrList', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeList')))
    _Container_time = INT(name='time', mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    _Container_gstrq = SEQ(name='gstrq', mode=MODE_TYPE, tag=(17, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'GetStampedRq')))
    _Container_gstrs = SEQ(name='gstrs', mode=MODE_TYPE, tag=(18, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'GetStampedRs')))
    _Container_efccontext = SEQ(name='efccontext', mode=MODE_TYPE, tag=(32, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'EFC-ContextMark')))
    _Container_vehlpn = SEQ(name='vehlpn', mode=MODE_TYPE, tag=(47, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'LPN')))
    _Container_vehclass = INT(name='vehclass', mode=MODE_TYPE, tag=(49, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleClass')))
    _Container_vehdims = SEQ(name='vehdims', mode=MODE_TYPE, tag=(50, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleDimensions')))
    _Container_vehaxles = SEQ(name='vehaxles', mode=MODE_TYPE, tag=(51, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleAxles')))
    _Container_vehwtlims = SEQ(name='vehwtlims', mode=MODE_TYPE, tag=(52, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleWeightLimits')))
    _Container_vehspchars = SEQ(name='vehspchars', mode=MODE_TYPE, tag=(54, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleSpecificCharacteristics')))
    _Container_equOBUId = OCT_STR(name='equOBUId', mode=MODE_TYPE, tag=(56, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'EquipmentOBUId')))
    _Container_paymeans = SEQ(name='paymeans', mode=MODE_TYPE, tag=(64, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'PaymentMeans')))
    _Container_setmmirq = INT(name='setmmirq', mode=MODE_TYPE, tag=(69, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'SetMMIRq')))
...
class EfcDsrcApplication:
    ...
    __GetInstanceRs__item__attributeValues = CHOICE(name='attributeValues', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Container')))
    ...
    _GetStampedRs_attributeList = SEQ_OF(name='attributeList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeList')))
    ...
    _SetInstanceRq_attribute = SEQ(name='attribute', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Attributes')))
    ...
    _SetStampedRq_attributeList = SEQ_OF(name='attributeList', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeList')))
...
class EfcDsrcGeneric:
    ...
    _Action_Request_eid = INT(name='eid', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')))
    _Action_Request_actionType = INT(name='actionType', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'ActionType')))
    ...
    _Action_Request_actionParameter = CHOICE(name='actionParameter', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Container')), opt=True)
    _Action_Request_iid = INT(name='iid', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')), opt=True)
    ...
    _Action_Response_eid = INT(name='eid', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')))
    _Action_Response_iid = INT(name='iid', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')), opt=True)
    _Action_Response_responseParameter = CHOICE(name='responseParameter', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Container')), opt=True)
    _Action_Response_ret = INT(name='ret', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'ReturnStatus')), opt=True)
    ...
    #-----< ApplicationContextMark >-----#
    ApplicationContextMark = CHOICE(name='ApplicationContextMark', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Container')))
    ...
    _AttributeList__item_ = SEQ(name='_item_', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Attributes')))
    ...
    _Attributes_attributeValue = CHOICE(name='attributeValue', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Container')))
    ...
    _Container_attrIdList = SEQ_OF(name='attrIdList', mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeIdList')))
    _Container_attrList = SEQ_OF(name='attrList', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeList')))
    _Container_broadcastPool = SEQ(name='broadcastPool', mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'BroadcastPool')))
    _Container_directory = SEQ_OF(name='directory', mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Directory')))
    _Container_file = SEQ_OF(name='file', mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'File')))
    _Container_fileType = NULL(name='fileType', mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'FileType')))
    _Container_record = CHOICE(name='record', mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Record')))
    _Container_time = INT(name='time', mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Time')))
    ...
    _Container_gstrq = SEQ(name='gstrq', mode=MODE_TYPE, tag=(17, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'GetStampedRq')))
    _Container_gstrs = SEQ(name='gstrs', mode=MODE_TYPE, tag=(18, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'GetStampedRs')))
    _Container_sstrq = SEQ(name='sstrq', mode=MODE_TYPE, tag=(19, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'SetStampedRq')))
    _Container_ginrq = SEQ(name='ginrq', mode=MODE_TYPE, tag=(20, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'GetInstanceRq')))
    _Container_ginrs = SEQ_OF(name='ginrs', mode=MODE_TYPE, tag=(21, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'GetInstanceRs')))
    _Container_sinrq = SEQ(name='sinrq', mode=MODE_TYPE, tag=(22, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'SetInstanceRq')))
    _Container_charq = SEQ(name='charq', mode=MODE_TYPE, tag=(23, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ChannelRq')))
    _Container_chars = SEQ(name='chars', mode=MODE_TYPE, tag=(24, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ChannelRs')))
    _Container_cpprq = SEQ(name='cpprq', mode=MODE_TYPE, tag=(25, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'CopyRq')))
    _Container_subrq = SEQ(name='subrq', mode=MODE_TYPE, tag=(26, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'SubRq')))
    _Container_addrq = SEQ(name='addrq', mode=MODE_TYPE, tag=(27, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'AddRq')))
    _Container_debrq = SEQ(name='debrq', mode=MODE_TYPE, tag=(28, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'DebitRq')))
    _Container_debrs = SEQ(name='debrs', mode=MODE_TYPE, tag=(29, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'DebitRs')))
    _Container_crerq = SEQ(name='crerq', mode=MODE_TYPE, tag=(30, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'CreditRq')))
    _Container_crers = SEQ(name='crers', mode=MODE_TYPE, tag=(31, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'CreditRs')))
    _Container_efccontext = SEQ(name='efccontext', mode=MODE_TYPE, tag=(32, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'EFC-ContextMark')))
    _Container_contser = INT(name='contser', mode=MODE_TYPE, tag=(33, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ContractSerialNumber')))
    _Container_contval = SEQ(name='contval', mode=MODE_TYPE, tag=(34, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ContractValidity')))
    _Container_contveh = SEQ(name='contveh', mode=MODE_TYPE, tag=(35, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ContractVehicle')))
    _Container_contauth = OCT_STR(name='contauth', mode=MODE_TYPE, tag=(36, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ContractAuthenticator')))
    _Container_recspt = SEQ(name='recspt', mode=MODE_TYPE, tag=(37, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptServicePart')))
    _Container_sessioncls = SEQ(name='sessioncls', mode=MODE_TYPE, tag=(38, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'SessionClass')))
    _Container_recservserialno = INT(name='recservserialno', mode=MODE_TYPE, tag=(39, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptServiceSerialNumber')))
    _Container_recfinptENV = NULL(name='recfinptENV', mode=MODE_TYPE, tag=(40, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Container_reccont = SEQ(name='reccont', mode=MODE_TYPE, tag=(41, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptContract')))
    _Container_recOBUId = OCT_STR(name='recOBUId', mode=MODE_TYPE, tag=(42, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptOBUId')))
    _Container_recICCId = OCT_STR(name='recICCId', mode=MODE_TYPE, tag=(43, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptICC-Id')))
    _Container_rectext = OCT_STR(name='rectext', mode=MODE_TYPE, tag=(44, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptText')))
    _Container_recauth = OCT_STR(name='recauth', mode=MODE_TYPE, tag=(45, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptAuthenticator')))
    _Container_recdist = INT(name='recdist', mode=MODE_TYPE, tag=(46, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptDistance')))
    _Container_vehlpn = SEQ(name='vehlpn', mode=MODE_TYPE, tag=(47, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'LPN')))
    ...
    _Container_vehaxles = SEQ(name='vehaxles', mode=MODE_TYPE, tag=(51, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleAxles')))
    _Container_vehwtlims = SEQ(name='vehwtlims', mode=MODE_TYPE, tag=(52, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleWeightLimits')))
    _Container_vehwtladen = INT(name='vehwtladen', mode=MODE_TYPE, tag=(53, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleWeightLaden')))
    _Container_vehspchars = SEQ(name='vehspchars', mode=MODE_TYPE, tag=(54, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleSpecificCharacteristics')))
    _Container_vehauth = OCT_STR(name='vehauth', mode=MODE_TYPE, tag=(55, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleAuthenticator')))
    _Container_equOBUId = OCT_STR(name='equOBUId', mode=MODE_TYPE, tag=(56, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'EquipmentOBUId')))
    _Container_equICCId = OCT_STR(name='equICCId', mode=MODE_TYPE, tag=(57, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ICC-Id')))
    _Container_equstat = BIT_STR(name='equstat', mode=MODE_TYPE, tag=(58, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'EquipmentStatus')))
    _Container_dvrchars = SEQ(name='dvrchars', mode=MODE_TYPE, tag=(59, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'DriverCharacteristics')))
    _Container_paymeansENV = NULL(name='paymeansENV', mode=MODE_TYPE, tag=(60, TAG_CONTEXT_SPEC, TAG_IMPLICIT))
    _Container_paymbal = CHOICE(name='paymbal', mode=MODE_TYPE, tag=(61, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'PaymentMeansBalance')))
    _Container_paymunit = OCT_STR(name='paymunit', mode=MODE_TYPE, tag=(62, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'PaymentMeansUnit')))
    _Container_paysecdata = OCT_STR(name='paysecdata', mode=MODE_TYPE, tag=(63, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'PaymentSecurityData')))
    _Container_paymeans = SEQ(name='paymeans', mode=MODE_TYPE, tag=(64, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'PaymentMeans')))
    _Container_recdata1 = SEQ(name='recdata1', mode=MODE_TYPE, tag=(65, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptData1')))
    _Container_recdata2 = SEQ(name='recdata2', mode=MODE_TYPE, tag=(66, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptData2')))
    _Container_valofcon = SEQ(name='valofcon', mode=MODE_TYPE, tag=(67, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ValidityOfContract')))
    _Container_recfinpt = SEQ(name='recfinpt', mode=MODE_TYPE, tag=(68, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ReceiptFinancialPart')))
    _Container_setmmirq = INT(name='setmmirq', mode=MODE_TYPE, tag=(69, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'SetMMIRq')))
    _Container_awl = SEQ(name='awl', mode=MODE_TYPE, tag=(70, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'AxleWeightLimits')))
    _Container_paca = SEQ(name='paca', mode=MODE_TYPE, tag=(71, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'PassengerCapacity')))
    _Container_eng = SEQ(name='eng', mode=MODE_TYPE, tag=(72, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'Engine')))
    _Container_sl = SEQ(name='sl', mode=MODE_TYPE, tag=(73, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'SoundLevel')))
    _Container_eev = SEQ(name='eev', mode=MODE_TYPE, tag=(74, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ExhaustEmissionValues')))
    _Container_dev = SEQ(name='dev', mode=MODE_TYPE, tag=(75, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'DieselEmissionValues')))
    _Container_co2ev = INT(name='co2ev', mode=MODE_TYPE, tag=(76, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'CO2EmissionValue')))
    _Container_vtd = INT(name='vtd', mode=MODE_TYPE, tag=(77, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'VehicleTotalDistance')))
    _Container_tlpn = SEQ(name='tlpn', mode=MODE_TYPE, tag=(78, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'TrailerLicencePlateNumber')))
    _Container_tch = SEQ(name='tch', mode=MODE_TYPE, tag=(79, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'TrailerCharacteristics')))
    _Container_anp = INT(name='anp', mode=MODE_TYPE, tag=(80, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcApplication', 'ActualNumberOfPassengers')))
    ...
    #-----< EfcContainer >-----#
    EfcContainer = CHOICE(name='EfcContainer', mode=MODE_TYPE, typeref=ASN1RefType(('EfcDsrcGeneric', 'Container')))
    ...
    _Event_Report_Request_eid = INT(name='eid', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')))
    _Event_Report_Request_eventType = INT(name='eventType', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'EventType')))
    ...
    _Event_Report_Request_eventParameter = CHOICE(name='eventParameter', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_EXPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Container')), opt=True)
    _Event_Report_Request_iid = INT(name='iid', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')), opt=True)
    ...
    _Get_Response_eid = INT(name='eid', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')))
    _Get_Response_iid = INT(name='iid', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')), opt=True)
    _Get_Response_attributelist = SEQ_OF(name='attributelist', mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeList')), opt=True)
    _Get_Response_ret = INT(name='ret', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'ReturnStatus')), opt=True)
    ...
    _NamedFile_name = SEQ(name='name', mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'FileName')))
    _NamedFile_file = SEQ_OF(name='file', mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'File')))
    ...
    _Set_Request_eid = INT(name='eid', mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')))
    ...
    _Set_Request_attrList = SEQ_OF(name='attrList', mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'AttributeList')))
    _Set_Request_iid = INT(name='iid', mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('EfcDsrcGeneric', 'Dsrc-EID')), opt=True)
...
init_modules(EfcDataDictionary, CccModule, AVIAEINumberingAndDataStructures, EfcDsrcApplication, EfcDsrcGeneric)
