...
from bac_l7 import gea_bcm_dll_wrapper, ops1955_bac_l7
tgbv_bac_l7 = gea_bcm_dll_wrapper
...
def safe_set_beacon(chosen_beacon_name):
    ...
    if chosen_beacon_name == 'TGBV':
        tgbv_bac_l7.set_beacon_name(beacon_name='TGBV')
        tgbv_bac_l7.initialize_gea_bcm_dll_wrapper()

        beacon_l7_wrapper = tgbv_bac_l7
...
def initialize_transaction(manufacturer_id=0x31, individual_id=0x111, mand_applications=[1, 20, 29], profile=0x00, profile_list=[0x00], non_mand_applications = []):
    ...
    if beacon_l7_wrapper.is_mode(mode_code=tgbv_bac_l7.BCM_MODE_Enum.BCM_MOD_Stopped):
