...
transaction_data_app.mount("/transaction-data", StaticFiles(directory="fronts/web/transaction_data_web_front", html=True), name="tolling_testing_web_front_files")