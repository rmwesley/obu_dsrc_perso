...
efc_cm = 'B28031000871'
auk_value_bytes = dsrc_key_derivation.compute_auk_plaintext(pan_bytes, efc_cm)
...
print(dsrc_key_derivation.force_compute_auk_with_efc_cm_and_auk_ref_only(pan_bytes, efc_cm, 111).hex())
